...
function updateTimer() {
    const targetDate = new Date("january 18, 2025 22:00:00").getTime();
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const recipientNumber1 = '543813599062'; // Número para el primer botón
    const recipientNumber2 = '543815972789'; // Número para el segundo botón
...
document.getElementById('musicForm').addEventListener('submit', function(event) {
    ...
    const telefono = '543813599062'; // Reemplaza esto con tu número de WhatsApp
